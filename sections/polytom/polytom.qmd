...
\begin{equation}
P(U_{ij} = 1 | u_{ij} \in \{0, 1\}, \theta_i, \delta_{jc}) = 
    \frac{
        exp( 0.3 )
    }{
        1 + exp( 0.3 )
...
\begin{equation}
P(U_{ij} = 2 | u_{ij} \in \{1, 2\}, \theta_i, \delta_{jc}) = 
    \frac{
        exp( -1.2 )
    }{
        1 + exp( -1.2 )
