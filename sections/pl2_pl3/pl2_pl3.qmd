...
\begin{equation}
    ...
    \gamma_j + (1 - \gamma_j) \cdot \frac{e^{(\theta_i - \beta_j)}}{1 + e^{\alpha_j (\theta_i - \beta_j)}}
\end{equation}
...
Welchen Wert erhalten Sie für $\lim_{\theta_i \to -\infty} P(U_{ij} = 1 | \theta_i, \beta_j, \alpha_j, \gamma_j)$? Interpretieren Sie das Ergebnis.
