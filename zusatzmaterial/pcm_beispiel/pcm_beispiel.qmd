...
Statt das Summenzeichen aufwendig für jeden Wert von $k$ aufzulösen, können Sie also gleich $\theta_i$ mit $l$ multiplizieren und den ersten bis $l^{\text{ten}}$ Schwellenparameter abziehen. Das geht viel schneller.
...
Die modellimplizierte Wahrscheinlichkeit im PCM, dass eine Person mit $\theta_i$ bei einem Item mit $\delta_{j1} = -1$, $\delta_{j2} = 0$, und $\delta_{j3} = 1$ in Kategorie $c = 2$ antwortet ist also $0.43$.
